...
contract AI_NFT is CollectionNFT_BASE("Anupriya Inumella's Melon Collection", "AI_NFT")
{
    ...
    function createSeed(string memory x, string memory y) private pure returns (string memory)
    {
        return
        string
        (
    ...
    function tokenURI(uint256 tokenId) public override view returns (string memory)
    {
        ...
        (
            ...
            ,   '", "description": "This is a watermelon", "image": "data:image/svg+xml;base64,'

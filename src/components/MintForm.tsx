...
function MintForm() {
    ...
    return (
        <>
            ...
            <div className={classes.root2} onKeyDown={handleKey}>
                <div className={classes.form}>
                    <DropDown_MintForm value={asset} list={collections} onChange={setAsset} />

                    <List className={classes.list} subheader={<ListSubheader>My assets</ListSubheader>}>
                        {assets.map((item, i) => (
                            <ListItem key={i}>
                                <ListItemAvatar>
                                    <Avatar>
                    ...
                    <Button className={classes.btnMint} variant="contained" onClick={handleMint} disabled={!asset.image}>
                        Mint
                    </Button>
                    <Button
                        ...
                        variant="outlined"
                        onClick={() => {
                            fetch("http://127.0.0.1:8000/subgraphs/name/example", {
                                method: "POST",
